...
export default function NewsTab({ symbol }) {
  ...
  if (error) return (
    <div style={{ padding: 32, textAlign: 'center', color: 'var(--text-3)', fontSize: 13 }}>
      ...
      Could not load news. Check your connection or API key.
    </div>
  )
    ...
    <div style={{ padding: '20px 24px' }}>
      ...
      {!llmEnabled && (
        <div style={{
          ...
          ⚠ ANTHROPIC_API_KEY not set — showing news without AI analysis.
          Add your key in Render → Environment → ANTHROPIC_API_KEY.
        </div>
      )}
      {llmEnabled && (
        <div style={{
          ...
          ✦ AI-powered analysis active — PESTEL categories and sentiment scored by Claude
        </div>
      )}
