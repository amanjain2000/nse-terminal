...
export const fetchHistory      = (sym, p) => req(`/api/stock/${sym}/history?period=${p || '1m'}`)
...
export const fetchNews         = (sym)    => req(`/api/stock/${sym}/news`)
export const fetchMacroPestel  = ()       => req('/api/macro/pestel')
